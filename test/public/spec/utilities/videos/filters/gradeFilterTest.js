define( function ( require ) {
	...
	describe( 'Grade Specific Content Filtering', function () {
		...
		arrFilters.forEach( function ( item ) {
			...
			var	strdes1 = 'should display ' + item + ' contents/videos for ' + item + ' teachers';
			var	strdes2 = 'should fetch all ' + ' contents/videos on the system';
			describe( strHead, function() {
				...
				var	video = copyObject( videoData );
				var	counttags = 0;
				var	fetchedtags = 0;
