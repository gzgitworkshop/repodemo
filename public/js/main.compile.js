...
define( 'MiddlewareRouter',['require','underscore','backbone','marionette','async'],function( require ) {
  'use strict';
...
define( 'routers/AppRouter',['require','marionette','MiddlewareRouter'],function ( require ) {
	'use strict';
...
define( 'models/videos/VideoModel',['require','backbone'],function ( require ) {
	'use strict';
...
define( 'views/videos/VideosListView',['require','marionette','views/videos/VideoItemView'],function ( require ) {
	'use strict';
...
define('text!templates/error.html',[],function () { return '<%= message %>';});

define( 'views/ErrorView',['require','underscore','marionette','text!templates/error.html'],function ( require ) {
	'use strict';
...
define( 'App',['require','marionette','backbone','routers/AppRouter','controllers/AppController','Communicator'],function ( require ) {
	'use strict';
...
define( 'config/index',['require','modernizr'],function ( require ) {
	'use strict';
